  ...
  return (
    <div className="container-page space-y-10">
      <section className="rounded-2xl bg-gradient-to-r from-brand-700 to-brand-900 p-8 text-white">
        <h1 className="text-3xl font-bold">Construction Materials Delivered Fast</h1>
        <p className="mt-2 max-w-2xl text-stone-200">Cement, bricks, tiles, steel, and coatings with bulk discounts and transparent shipping by weight.</p>
        <Link to="/products" className="btn mt-4 inline-block bg-white text-brand-900 hover:bg-stone-100">Shop Now</Link>
      </section>
